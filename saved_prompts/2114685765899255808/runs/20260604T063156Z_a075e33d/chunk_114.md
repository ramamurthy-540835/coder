ider and run it. Once complete, share the output and I'll verify all views were
 created correctly.
...
Running secure command: aider --model xai/grok-4.20-non-reasoning --edit-format diff --map-tokens 1024 --